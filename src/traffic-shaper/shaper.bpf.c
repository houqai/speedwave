/*
 * SpeedWave Traffic Shaper (eBPF + EDT Edition)
 *
 * eBPF engine vendored from DonMatteoVPN/Reshala-Remnawave-Bedolaga
 * (modules/local/shaper.bpf.c), licensed GPL. Logic unchanged.
 *
