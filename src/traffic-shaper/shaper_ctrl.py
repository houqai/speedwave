#!/usr/bin/env python3
# ============================================================ #
# ==        SpeedWave eBPF TRAFFIC SHAPER CONTROLLER        == #
# ==              shaper_ctrl.py  (Multi-Rule)              == #
# ============================================================ #
#
...
#
# Движок основан на DonMatteoVPN/Reshala-Remnawave-Bedolaga (reshala_ctrl.py),
# адаптирован для SpeedWave. Чистый stdlib; управляет картами через bpftool.
#
...
DEFAULT_PIN_DIR   = "/sys/fs/bpf/speedwave/maps"
DEFAULT_RULES_FILE = "/etc/speedwave/traffic_shaper/rules.json"
